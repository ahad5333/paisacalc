...
// must be called from a Client Component, and GratuityCalculator reads
// window.location.search directly.
export const GratuityCalculatorLoader = dynamic(
  () => import("./GratuityCalculator").then((m) => m.GratuityCalculator),
  {
    ssr: false,
    loading: () => (
