...
// must be called from a Client Component, and PrepaymentCalculator reads
// window.location.search directly.
export const PrepaymentCalculatorLoader = dynamic(
  () => import("./PrepaymentCalculator").then((m) => m.PrepaymentCalculator),
  {
    ssr: false,
    loading: () => (
