...
// must be called from a Client Component, and InHandSalaryCalculator reads
// window.location.search directly.
export const InHandSalaryCalculatorLoader = dynamic(
  () => import("./InHandSalaryCalculator").then((m) => m.InHandSalaryCalculator),
  {
    ssr: false,
    loading: () => (
